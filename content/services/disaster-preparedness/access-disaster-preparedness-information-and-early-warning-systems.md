# Disaster Information & Early Warning Systems — Municipality of Aringay

Access **PAGASA, PHIVOLCS, and MDRRMO Aringay** warnings for typhoon, flood (Aringay River), storm surge/tsunami (Lingayen Gulf), earthquake, and landslide.
...
## MDRRMO Aringay Early Warning Flow
...
- **Before season (May):** Visit **Barangay Hall** to confirm **family contact + evacuation center assignment** is listed in **Barangay Master List**
- **During weather:** Check **PAGASA + MDRRMO FB every 3 hours**; keep **power bank charged**, **AM/FM radio** (MDRRMO recommends)
- **SMS/Call:** Ensure **Barangay Secretary has your mobile** — Tanods call vulnerable households (PWD/seniors) first
- **Go Bag:** IDs, meds, flashlight, water, cash — at door during Signal 1+

---

## Contact — Aringay

**MDRRMO / Operations Center — Municipality of Aringay**
Municipal Hall, Marcos Ave, Poblacion, Aringay, La Union 2503
**(072) 607-9531** — emergency 24/7 — also **PNP Aringay**
**Barangay Halls** — 24 barangays, BDRRM
**PAGASA** — pagasa.dost.gov.ph — **PHIVOLCS** — phivolcs.dost.gov.ph

**Not official:** random FB pages, old GC forwards — verify with **MDRRMO Aringay** first.
